...
public final class PaginationUtil {
    ...
    public static <T> HttpHeaders generatePaginationHttpHeaders(UriComponentsBuilder uriBuilder, Page<T> page) {
    	...
    	HttpHeaders headers = new HttpHeaders();
    	headers.setAccessControlExposeHeaders(Arrays.asList(HEADER_X_TOTAL_COUNT,HEADER_X_PAGE_NUMBER,HEADER_X_PAGE_SIZE, HEADER_X_TOTAL_PAGE, HEADER_LINK_FORMAT));
        ...
        headers.set(HEADER_X_PAGE_SIZE, Integer.toString(pageSize));
 
        headers.set(HEADER_X_TOTAL_PAGE, Integer.toString(page.getTotalPages()));
